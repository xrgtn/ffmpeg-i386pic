...
cglobal %1_h264_qpel4_h_lowpass, 4,5 ; dst, src, dstStride, srcStride
    ...
    movsxdifnidn  r3, r3d
    pxor          m7, m7
    PIC_BEGIN r4d, 0 ; r4d not initialized yet
...
cglobal %1_h264_qpel8_h_lowpass, 4,5 ; dst, src, dstStride, srcStride
    ...
    PIC_BEGIN r5
    CHECK_REG_COLLISION "rpic","r0","r1","r2","r3","r4d"
    movsxdifnidn  r2, r2d
    movsxdifnidn  r3, r3d
    mov          r4d, 8
    pxor          m7, m7
...
cglobal %1_h264_qpel4_h_lowpass_l2, 5,6 ; dst, src, src2, dstStride, srcStride
    PIC_BEGIN r5d, 0 ; r5d not initialized yet
...
cglobal %1_h264_qpel8_h_lowpass_l2, 5,6 ; dst, src, src2, dstStride, srcStride
    %define rpicsave ; safe to push/pop rpic
    PIC_BEGIN r6
    CHECK_REG_COLLISION "rpic","r0","r1","r2","r3","r4","r5d"
    movsxdifnidn  r3, r3d
    movsxdifnidn  r4, r4d
    mov          r5d, 8
    pxor          m7, m7
...
; src, tmp, srcSize
%macro FILT_HV 1 ; offset ; r0..2; PIC
    mova           m6, m2
    movh           m5, [r0]
    paddw          m6, m3
    psllw          m6, 2
    CHECK_REG_COLLISION "rpic",%1,"r0","r1","r2"
    PIC_BEGIN r4
    paddw          m0, [pic(pw_16)]
    psubw          m6, m1
    psubw          m6, m4
...
cglobal %1_h264_qpel4_hv_lowpass_v, 3,3 ; src, tmp, srcStride
    ...
    punpcklbw     m3, m7
    punpcklbw     m4, m7
    FILT_HV       0*24 ; r0..2; PIC
    FILT_HV       1*24
    FILT_HV       2*24
    FILT_HV       3*24 ; r0..2; PIC
    PIC_END ; r3, push/pop
    RET
